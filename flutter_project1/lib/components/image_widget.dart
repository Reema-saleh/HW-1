...
class ImageWidget extends StatelessWidget {
  const ImageWidget(
      ...
      this.isNetwork = false, //my images mostly will be from the asset so that is the default
      this.imgWidth,
      this.imgHeight});
  final String imgPath;
  final bool isNetwork;
  //opetional parametors because i don't to change the size of the image always
